...
- Remote JavDB operations are exposed only through the top-level `javdb` public SDK; do not import `internal/javdb/appapi` or `internal/javdb/protocol/*` adapters directly from CLI code.

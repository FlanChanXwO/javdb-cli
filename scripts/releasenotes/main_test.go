...
`)
	report := auditReport{Sources: []auditSource{
		{Kind: "pull_request", URL: "https://github.com/FlanChanXwO/javdb-cli/pull/42", Note: &releaseNote{Category: "Added", Summary: "Add one."}},
		{Kind: "pull_request", URL: "https://github.com/FlanChanXwO/javdb-cli/pull/43", Note: &releaseNote{Category: "Fixed", Summary: "Fix two."}},
	}}
...
func TestPreparePlanRequiresAuditedNewContributor(t *testing.T) {
	...
	report := auditReport{
		Sources:         []auditSource{{Kind: "pull_request", URL: "https://github.com/FlanChanXwO/javdb-cli/pull/42", Note: &releaseNote{Category: "Added", Summary: "Add one."}}},
		NewContributors: []newContributor{{Login: "new-contributor", ProfileURL: "https://github.com/new-contributor", PullNumber: 42, PullURL: "https://github.com/FlanChanXwO/javdb-cli/pull/42"}},
	}
